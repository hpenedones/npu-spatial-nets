...
\begin{tikzpicture}[line cap=round, line join=round]
  ...
  \node[bodybox, minimum width=1.55cm] (b1) at (8.55, 6.9) {Residual 1\\Tile 2};
  \node[font=\Large, text=textgray] (dots) at (10.45, 6.9) {$\cdots$};
  \node[bodybox, minimum width=1.75cm] (bl) at (12.35, 6.9) {Residual 30\\Tile 31};
  \node[bodybox, minimum width=1.55cm] (headnpu) at (14.35, 6.9) {Head\\Tile 32};
  ...
  \draw[->, thick, shorten <=1pt, shorten >=1pt] (input.east) -- (pad.west);
  \draw[->, thick, shorten <=1pt, shorten >=1pt] (pad.east) -- (embed.west);
  \draw[->, thick, shorten <=1pt, shorten >=2pt] (embed.east) -- (b1.west);
  \draw[->, thick, shorten <=2pt, shorten >=1pt] (b1.east) -- (dots.west);
  \draw[->, thick, shorten <=1pt, shorten >=2pt] (dots.east) -- (bl.west);
  \draw[->, thick, shorten <=1pt, shorten >=2pt] (bl.east) -- (headnpu.west);
  \draw[->, thick, shorten <=1pt, shorten >=1pt] (headnpu.east) -- (strip.west);
  \draw[->, thick, shorten <=1pt, shorten >=1pt] (strip.east) -- (output.west);

  \node[framebox, fit=(embed)(b1)(dots)(bl)(headnpu), inner xsep=0.42cm, inner ysep=0.42cm,
