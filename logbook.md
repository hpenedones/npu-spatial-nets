...
## Phase 4: Block-Recurrent Character LM (current)

See README.md and the whitepaper for full details. This phase traded peak
TFLOPS for a richer architecture with 32 distinct weight matrices, RMSNorm,
residual connections, and character embeddings — an actual language model.
